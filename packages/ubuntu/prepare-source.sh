#!/usr/bin/env bash
# Helper script to prepare a Debian source package for fip-c
...
BASE_URL="https://github.com/flint-lang/fip/releases/download/${RELEASE_TAG}"
...
curl -L --fail -o "${SRC_DIR}/fip-c"    "${BASE_URL}/fip-c"
chmod +x "${SRC_DIR}/fip-c"
...
echo "     cd fip-c-${VERSION} && ../build.sh"
