# Ubuntu / Debian packaging for fip-c
...
where `$VERSION` needs to be replaced with the Flint version like `0.4.1`. A new directory `fip-c-0.4.1` will be created. You then need to cwd into that directory to build the package
